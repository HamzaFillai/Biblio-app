...
$res=$bdd->query("SELECT * FROM users where role='null'");
...
<body>
	...
	<div class="section">
		...
		<h1> Listes des adhérents </h1>
		<br/>
		<p style="font-weight: bold;font-size: 18px; "><i class="fas fa-exclamation-triangle fa-2x" style="color: red;"></i>Si vous voulez modfié un adhérent, vous cliquez sur l'icon qui est en bleu après vous cliquez sur ajoutez adhérent et comme ça votre adhérent sera modifié</p>
					...
					while($don=$res->fetch())
						{?>
							<tr>
								...
								<td><?php echo $don["cin"]; ?></td>
								<td><?php echo $don["phone"]; ?></td>
								<td><?php echo $don["email"];?></td>
								<td><?php echo $don["address"]; ?></td>
								<td >
									<a style="color: red;" href="listadh.php?delete=<?php echo $don["id"]; ?>"><i class="fas fa-trash-alt"></i></a> <span style="opacity: 0">hh</span>
									<a  href="listadh.php?edit=<?php echo $don["id"]; ?>"><i class="fas fa-pen-alt"></i></a>
								</td>
							</tr>
						<?php
						}
	...
	<div class="modal-bg">
		<form class="modal" action="listadh.php" method="post">
	...
	<div class="ajoutadh">
		<form class="formadh" action="listadh.php" method="post">
			...
			<p>
				...
				<?php
				 ...
				 {?>
				 	...
				 	<script>swal('Good job!', 'He has been added !', 'success'); setTimeout('window.location.href = "listadh.php";',3000);</script>
				 <?php	
				 }
				?>
				<?php
			...
			<table>
				<tr>
					...
					<td><input class="inp1" ype="text" name="username" id="username" required="" value=<?php if(isset($username)) echo $username;?>></td>
				</tr>
				<tr>
					<td align="right"><label>Email : </label></td>
					<td><input class="inp1" type="email" name="mail" ismap="mail" required="" value=<?php if(isset($email)) echo $email;?>></td>
				</tr>
				<tr>
					<td align="right"><label>Phone : </label></td>
					<td><input class="inp1" type="text" name="phone" id="phone" required="" value=<?php if(isset($phone)) echo $phone;?>></td>
				</tr>
				<tr>
					<td align="right"><label>Adresse : </label></td>
					<td><input class="inp1" type="text" name="adresse" id="adresse" required="" value=<?php if(isset($address)) echo $address;?>></td>
				</tr>
				<tr>
					<td align="right"><label>CIN : </label></td>
					<td><input class="inp1" type="text" name="cin" id="cin" required="" value=<?php if(isset($cin)) echo $cin;?>></td>
				</tr>
			</table>
	...
	<div class="ajoutb">
		<form class="formb" action="listadh.php" method="post">
	...
	<div class="modp">
		<form class="formp" action="listadh.php" method="post">
